...
const TopProducts = ({ handleOrderPopup }) => {
  return (
    <div>
      <div className="container dark:bg-gray-950 dark:text-white duration-200">
        {/* Header section */}
            ...
            >
              ...
              <div className="h-[100px]">
                <img
                  src={data.img}
                  alt=""
                  className="max-w-[140px] block mx-auto transform -translate-y-20 group-hover:scale-125 duration-1000 drop-shadow-md"
                />
              </div>
